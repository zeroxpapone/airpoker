...
export default function LoginPage() {
  const { login, registerWithEmail, loginWithEmail, signInWithGoogle, signInWithApple, loading } = useAuth();
  ...
  async function handleAppleLogin() {
    ...
    try {
      ...
      console.error(err);
      setErrorMsg(err?.message || t("login.errorAppleAuth") || "Errore durante l'autenticazione con Apple.");
    } finally {
      setSubmitting(false);
    }
  }
